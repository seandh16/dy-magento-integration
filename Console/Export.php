...
class Export extends Command
{
    ...
    public function export()
    {
        ...
        while($limit === $selected) {
            ...
            echo "Saved " . $limit . " from line " . $offset . "\n";
        }
    ...
    public function readLine(Product $product)
    {
        ...
        $this->_productResource->load($_product, $product->getId());
        ...
        foreach ($attributes as $attribute) {
            if ($attribute->getIsGlobal() && !in_array($attribute->getAttributeCode(), $this->_excludedAttributes)) {
